...
5. Choose Finish.
After about a minute the PersonsList Extension-002 application, running on local SAP HANA Cloud test server, is launched with the external Web browser you configured before.
...
4.2.2 Publish and Run PersonsList Application on your Trial Developer Account
  ...
  8. Choose Finish.
After about a minute the PersonsList Extension-002 application, running on SAP HANA Cloud, is launched with the external Web browser you configured before.
